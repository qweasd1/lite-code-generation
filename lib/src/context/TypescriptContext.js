...
exports.TypescriptContext = TypescriptContext;
const config = {
    indent: "  ",
    EOL: "\n",
    brackets: {
...
//   }
//   const ctx = new TypescriptContext("aa ", config, state, null, null)
//   ctx.body(() => {
//     const subctx = new TypescriptContext("function test() ", config, state, ctx, null)
//     subctx.bracket("(",()=>{
//       new TypescriptContext("name", config, state, subctx, null)
//       new TypescriptContext("age", config, state, subctx, null)
//     })
//     subctx.body(() => {
//       new TypescriptContext("other", config, state, subctx, null)
//     })
//
//   })
...
// }
// test()
//# sourceMappingURL=TypescriptContext.js.map